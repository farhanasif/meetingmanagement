 ...
 <meta name="viewport" content="width=device-width, initial-scale=1">
  ...
  <link rel="stylesheet" href="{{asset('admin/css/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css')}}">
  <!-- iCheck -->
  ...
  <!-- Daterange picker -->
  <link rel="stylesheet" href="{{asset('admin/css/plugins/daterangepicker/daterangepicker.css')}}">
  <!-- summernote -->
