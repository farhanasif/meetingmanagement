                  ...
                  <div class="tab-pane active" id="profile">
                    ...
                    <form class="form-horizontal" action="http://103.108.144.246/erstate/public/index.php/update/userProfile" method="post">
                      ...
                      <div class="form-group row ">
                        ...
                        <div class="col-sm-10">
                          <input type="number" class="form-control" name="phone" id="phone" placeholder="Email" value="">
                        </div>
                      </div>
                      <div class="form-group row ">
                        <label for="inputEmail" class="col-sm-2 col-form-label">Cell Number<span style="color: red;">*</span></label>
                        <div class="col-sm-10">
                          <input type="number" class="form-control" name="cnumber" id="cnumber" placeholder="Email" value="">
                        </div>
                      </div>
                      <div class="form-group row">
