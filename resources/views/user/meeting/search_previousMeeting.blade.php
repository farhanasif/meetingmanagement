@extends('user.master')
@section('title', 'Search Previous Meeting')
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Search Previous Meeting</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Dashboard of Search Meeting</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Search Previous Meeting</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <form role="form">
                  ...
                  <div class="col-sm-4">
                    ...
                    <div class="col-sm-4">
                      <div class="form-group">
                        ...
                        <select class="form-control" id="mtitleId">
...
<script>
    $('#mtitleId').change(function (e) {
        e.preventDefault();
        $.ajax({
                type: "get",
                url:"{{url('/print/meeting')}}",
