                  ...
                  <div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                    ...
                    <div class="card-body text-left">
                        <div class="row">
                            <div class="col-sm-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <p>Sports 1 &nbsp;&nbsp;&nbsp; <a href="#" class="btn btn-info btn-xs" title="Edit"><i class="far fa-edit"></i></a></p>
                                </div>
                            </div>
                            <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <p class="text-left">
                                <ul>
                                    <li>Md. Sayed Ali | Deputy Secretary | Youth &nbsp;&nbsp;&nbsp;<a href="#" class="btn btn-danger btn-xs text-white"><i class="fas fa-times"></i></a></li>
                                    ...
                                    <li>Md. Abdur Roshid | Assistant Secretary | Coordination &nbsp;&nbsp;<a href="#" class="btn btn-danger btn-xs text-white"><i class="fas fa-times"></i></a></li>
                                </ul>
                                </p>
                            </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <p>Gerneral meeting &nbsp;&nbsp;&nbsp; <a href="#" class="btn btn-info btn-xs" title="Edit"><i class="far fa-edit"></i></a></p>
                            </div>
                            </div>
                            <div class="col-sm-2">
                            <div class="form-group">
                                <label>Meeting Date</label>
                                <p>10 Jan 2021 &nbsp;&nbsp;&nbsp; <a href="#" class="btn btn-info btn-xs" title="Edit"><i class="far fa-edit"></i></a></p>
                            </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <!-- select -->
                            <div class="form-group">
                                <label> From Meeting :</label>
                                <p>2:30 pm &nbsp;&nbsp;&nbsp; <a href="#" class="btn btn-info btn-xs" title="Edit"><i class="far fa-edit"></i></a></p>
                            </div>
                            </div>
                            <div class="col-sm-3">
                            <div class="form-group">
                                <label>To Meeting</label>
                                <p>4:30 pm &nbsp;&nbsp;&nbsp; <a href="#" class="btn btn-info btn-xs" title="Edit"><i class="far fa-edit"></i></a></p>
                            </div>
                            </div>
                            <div class="col-sm-3">
                            <div class="form-group">
                                <label>Preferred meeting location</label>
                                <p>Confefrence Room - 1 &nbsp;&nbsp;&nbsp; <a href="#" class="btn btn-info btn-xs" title="Edit"><i class="far fa-edit"></i></a></p>
                            </div>
                            </div>
                            <div class="col-sm-3">
                            <div class="form-group">
                                <label>Meeting Type</label>
                                <p>Physical Meeting &nbsp;&nbsp;&nbsp; <a href="#" class="btn btn-info btn-xs" title="Edit"><i class="far fa-edit"></i></a></p>
                            </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <p>Half day &nbsp;&nbsp;&nbsp; <a href="#" class="btn btn-info btn-xs" title="Edit"><i class="far fa-edit"></i></a></p>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <!-- select -->
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <ul>
                                        <li>Arrange Lunch &nbsp;&nbsp;&nbsp; <a href="#" class="btn btn-info btn-xs" title="Edit"><i class="far fa-edit"></i></a></li>
                                        <li>Provide gate pass to stack holders &nbsp;&nbsp;&nbsp; <a href="#" class="btn btn-info btn-xs" title="Edit"><i class="far fa-edit"></i></a></li>
                                        <li>Arrange virtual platform &nbsp;&nbsp;&nbsp; <a href="#" class="btn btn-info btn-xs" title="Edit"><i class="far fa-edit"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-sm-6">
